...
export default function AnalysisPage() {
  ...
  async function handleStartAnalysis() {
    ...
    // GitHub URL이 등록되어 있는지 확인
    if (!team.github_url) {
      toast({
        title: "연동 설정 필요",
        description: "분석을 시작하려면 먼저 GitHub을 연동해야 합니다.",
        variant: "destructive",
      });
      return;
    }
  ...
  const activityTrendData = [
    { week: 'Week 1', commits: 15, prs: 2 },
    { week: 'Week 2', commits: 22, prs: 4 },
    { week: 'Week 3', commits: 28, prs: 6 },
    { week: 'Week 4', commits: 35, prs: 8 },
    { week: 'Week 5', commits: 42, prs: 10 },
    { week: 'Week 6', commits: 48, prs: 12 },
  ];
