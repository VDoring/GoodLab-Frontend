...
GoodLab은 대학 교육 현장에서 팀 프로젝트를 효율적으로 관리하고, GitHub/Notion 데이터를 분석하여 객관적인 팀원 기여도를 확인할 수 있는 플랫폼입니다.

### 핵심 기능

- 4단계 권한 시스템 (슈퍼관리자/교수/팀장/학생)
- QR 코드 및 링크를 통한 간편한 팀 참여
- GitHub/Notion 활동 자동 분석 (시뮬레이션)
...
### 3. GitHub/Notion 연동 및 분석

- **연동 설정**: 팀원 누구나 GitHub/Notion URL 등록 가능
...
- **통계 카드**:
  ...
  - 완료된 분석 수
- **최근 활동**: 문서 작성, 분석 완료 등
- **팀 통계**: GitHub 커밋, Notion 페이지, PR 수
